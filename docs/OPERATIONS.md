...
Актуальный код уже находится в GitHub. Следующая последовательность сохранена как инструкция первоначального импорта: после завершённого переноса повторять её не нужно. Проверка шага 5 ожидает четыре новых исходника и остановится, если они уже совпадают с GitHub. При повторной привязке сначала сравните существующее состояние и сохраните локальные файлы.
